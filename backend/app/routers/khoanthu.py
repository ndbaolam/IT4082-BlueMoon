...
@router.post("/", response_model=schema.KhoanThuResponse)
...
@router.get("/", response_model=List[schema.KhoanThuResponse])
...
@router.get("/{khoanthu_id}", response_model=schema.KhoanThuResponse)
...
@router.put("/{khoanthu_id}", response_model=schema.KhoanThuResponse)
...
@router.delete("/{khoanthu_id}", response_model=schema.KhoanThuResponse)
